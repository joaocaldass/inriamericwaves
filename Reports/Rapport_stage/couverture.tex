...
\noindent {\Large Méthode d'adaptation de maillage à des surfaces et variables physiques appliquée à des problèmes de la mécanique des fluides}
...
\noindent {\Large Méthode de décomposition de domaine appliquée à la résolution de modèles non linéaires et dispersives pour la propagation des ondes}
