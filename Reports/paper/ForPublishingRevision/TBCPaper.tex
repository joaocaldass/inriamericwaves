...
\indent Therefore, in the sequel of this paper, we will continue using the \deleted{approximate TBCs given by the }operators $\Theta_i^{c}, \ i=1,2,3$, defined in \eqref{eq:appTBCP0}.