...
\noindent where $ \Upsilon_i, \ \ i=1,2,3$, are the external boundary conditions (\emph{i.e.}, defined on $\partial \Omega_i \backslash \Gamma$). \begingroup \color{red}The method given by is \eqref{eq:problemDDM1}-\eqref{eq:problemDDM2} is also known as Schwarz Waveform Relaxation method \cite{Blayo2007}. \endgroup
